(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("simple-jas", [], factory);
	else if(typeof exports === 'object')
		exports["simple-jas"] = factory();
	else
		root["simple-jas"] = factory();
...
var asciiToArray = __webpack_require__(173),
    hasUnicode = __webpack_require__(54),
...
var _find2 = __webpack_require__(85);
...
var _split2 = __webpack_require__(168);

var _split3 = _interopRequireDefault(_split2);

var _isPlainObject2 = __webpack_require__(175);
...
var _snakeCase2 = __webpack_require__(177);

var _snakeCase3 = _interopRequireDefault(_snakeCase2);

var _trimEnd2 = __webpack_require__(187);

var _trimEnd3 = _interopRequireDefault(_trimEnd2);

var _forEach2 = __webpack_require__(192);
...
exports.default = {
  serialize: function serialize(dataObject) {
    ...
    return (0, _assign2.default)({}, { data: this.serializeData(dataObject) }, other);
  },
  serializeData: function serializeData(object) {
    ...
    (0, _forEach3.default)(object, function (value, key) {
      ...
      if (key.endsWith('Id')) {
        var relationshipKey = (0, _trimEnd3.default)(key, 'Id');
        var type = (0, _snakeCase3.default)(relationshipKey);
        data.relationships[relationshipKey] = { data: { id: value, type: type } };
        return;
      }

      // Match relationship base on key & value
      if (key.endsWith('Ids') && (0, _isArray3.default)(value)) {
        var _relationshipKey = (0, _trimEnd3.default)(key, 'Ids');
        var _type = (0, _snakeCase3.default)(_relationshipKey);
        var rioArray = [];
      ...
      if ((0, _isArray3.default)(value) && (0, _isPlainObject3.default)(value[0])) {
        var _type2 = (0, _snakeCase3.default)(key);
        var _rioArray = [];
      ...
      // Match relationship base on value
      if ((0, _isPlainObject3.default)(value) && value.id) {
        var _type3 = (0, _snakeCase3.default)(key);
  ...
  deserializeErrors: function deserializeErrors(errors) {
    ...
    (0, _forEach3.default)(errors, function (item) {
      var pointerArray = (0, _split3.default)(item.source.pointer, '/');
      var index = 3;
  ...
  _deserializeArrayData: function _deserializeArrayData(data) {
    ...
    var objectArray = [];
    (0, _forEach3.default)(data, function (resourceObject) {
      var object = _this._deserializeResourceData(resourceObject, included);
  ...
  _deserializeResourceData: function _deserializeResourceData(data) {
    ...
    var newTree = (0, _concat3.default)(deserializationTree, { type: data.type, id: object.id });

    if (data.attributes) {
      (0, _forEach3.default)(data.attributes, function (value, name) {
        object[name] = value;
      });
    }

    if (data.relationships) {
      (0, _forEach3.default)(data.relationships, function (value, name) {
        if ((0, _isArray3.default)(value.data)) {
          object[name] = [];

          (0, _forEach3.default)(value.data, function (rio) {
            var relationshipData = (0, _find3.default)(included, { type: rio.type, id: rio.id });
            if (relationshipData) {
              var relationshipObject = _this2._deserializeResourceData(relationshipData, included, newTree);
              object[name].push(relationshipObject);
            }
          });
        }

        if ((0, _isPlainObject3.default)(value.data)) {
          if ((0, _find3.default)(deserializationTree, { type: value.data.type, id: value.data.id })) {
            object[name] = value.data;
          } else {
            var rio = value.data;
            var relationshipData = (0, _find3.default)(included, { type: rio.type, id: rio.id });
            if (relationshipData) {
              object[name] = _this2._deserializeResourceData(relationshipData, included, newTree);
            } else {
              object[name] = rio;
            }
          }
...
var createCompounder = __webpack_require__(178);
...
var arrayReduce = __webpack_require__(179),
    deburr = __webpack_require__(180),
    words = __webpack_require__(183);
...
var deburrLetter = __webpack_require__(181),
    toString = __webpack_require__(7);
...
var basePropertyOf = __webpack_require__(182);
...
var asciiWords = __webpack_require__(184),
    hasUnicodeWord = __webpack_require__(185),
    toString = __webpack_require__(7),
    unicodeWords = __webpack_require__(186);
...
//# sourceMappingURL=simple-jas.js.map